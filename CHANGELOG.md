...
- Add info alert linked to account type in transaction requesr page ([#31840](https://github.com/MetaMask/metamask-extension/pull/31840))
...
- Fix keyboard shortcut(Alt+Shift+M) broken on Chrome ([#31844](https://github.com/MetaMask/metamask-extension/pull/31844))
- Prevent address input crash on invalid CAIP account ID ([#  ](https://github.com/MetaMask/metamask-extension/pull/31934))
